...
import { GetCareersByTypeType } from "@cust-types/admin/careerTypes";
...
export const ListCareers = ({ name }: Props) => {
  ...
  const { loading: loadingCareers, data: dataCareers, refetch: refetchCareers } = useQuery<GetCareersByTypeType>(GET_CAREERS_BY_TYPE, {
