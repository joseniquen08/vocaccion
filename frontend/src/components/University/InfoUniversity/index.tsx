...
export const InfoUniversity = ({ id, user }: Props) => {
  ...
  const { loading: loadingUniversity, data: dataUniversity, refetch: refetchUniversity } = useQuery<GetUniversityByIdType>(GET_UNIVERSITY_BY_ID, {
    variables: { id }
  })
  ...
  const createCommentUniversity = async (e: FormEvent<HTMLDivElement>) => {
    e.preventDefault();
          ...
          dataUniversity && (
            ...
            >
              ...
              <HStack
                ...
                alignItems='end'
              >
                <Image src={dataUniversity.getUniversityById.image} alt={dataUniversity.getUniversityById.name} flex='none' objectFit='contain' w='5rem' h='5rem' mr='0.1rem'/>
