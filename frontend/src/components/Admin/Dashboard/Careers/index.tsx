...
import { GetAllCareersType } from '../../../../types/admin/careerTypes';
import { GetAllUniversitiesSelectType, UniversityType } from '../../../../types/admin/universityTypes';
...
export const Careers = () => {
  ...
  const [universities, setUniversities] = useState<(Omit<UniversityType, 'id'> & { '_id': string })[]>([]);
  const [selectedId, setSelectedId] = useState<string>("");

  const { loading: loadingUniversities, data: dataUniversities } = useQuery<GetAllUniversitiesSelectType>(GET_UNIVERSITIES);
  const { loading: loadingCareers, data: dataCareers, refetch: refetchCareers } = useQuery<GetAllCareersType>(GET_CAREERS);
