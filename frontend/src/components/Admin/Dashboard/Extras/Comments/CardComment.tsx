...
export const CardComment = ({ id, content, createdAt, user, idPage, namePage, imagePage, comment, handleModalComment }: Props) => {
  return (
      ...
      <HStack alignItems='start' w='full'>
        <HStack w='50%' spacing={2}>
          <HStack flex='none' mr={0.25} alignItems='center' justifyContent='center' rounded='lg' overflow='hidden'>
            <Image src={user.image === '' ? '/images/user-default.png' : user.image} flex='none' objectFit='contain' w='2.2rem' h='2.2rem' alt={user.name}/>
          </HStack>
        ...
        <HStack w='50%'>
          <HStack flex='none' bg='white' mr={0.25} alignItems='center' justifyContent='center' rounded='lg' overflow='hidden'>
            <Image src={imagePage} flex='none' objectFit='contain' w='2.2rem' h='2.2rem' alt={namePage}/>
          </HStack>
          <VStack alignItems='left' spacing={0}>
